...
<head>
	...
	<link rel="stylesheet" href="../../css/editarLibro-style.css"> 
...
<body>
	...
	<div class="container">
		...
		<?php include 'getLibro.php';?> <!-- INCLUDE -->
		<div class="row formulario">
			<div class="vista-previa col-lg-5">
				<img id="preview" hidden src="../../img/images.jpg" alt="">
				<div class="cover col-lg-6 col-md-6">
					<img src="<?php echo "../../".$fotoFrente; ?>">
				</div>
				<div class="back col-lg-6 col-md-6">
					<img src="<?php echo "../../".$fotoAtras; ?>">
				</div>
				<button  id="tomar-nuevas" class="btn btn-default"><span class="glyphicon glyphicon-camera"></span> Tomar nuevas fotos</button>
			</div>
			<form id="nuevo-libro" action="editaLibro.php" method="post"  enctype="multipart/form-data" class="col-lg-7">
				...
				<div class="form-group">
					 ...
					 <div class="inputs col-lg-6">
					 	<input type="text" hidden name="id" value="<?php echo $id; ?>" placeholder="">
					 	<input type="text" class="form-control" name="isbn" id="isbn" placeholder="0803287682" value="<?php echo $isbn; ?>">
					 	<input type="text" required class="form-control" name="autor" id="autor" placeholder="Julio Verne" value="<?php echo $autor; ?>">
